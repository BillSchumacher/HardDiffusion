...
class GeneratedImage(models.Model):
    ...
    guidance_scale = models.FloatField(blank=True, null=True, default=7.5)
    num_inference_steps = models.IntegerField(blank=True, null=True, default=50)
    height = models.IntegerField(blank=True, null=True, default=512)
    width = models.IntegerField(blank=True, null=True, default=512)
